...
function ItemOrder(){
    return (
      <div className={"item-order"}>
          <img className={"img-order"} alt={"food"} src={"https://comnieuthienly.com/_next/image?url=https%3A%2F%2Fhos.comnieuthienly.com%2Fimages%2Fwebp%2F674ac922bdc46c2b04a4dea9.png&w=3840&q=75"}/>
